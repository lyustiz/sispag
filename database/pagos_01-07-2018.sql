...
-- Records of cuenta
-- ----------------------------
INSERT INTO "pagos"."cuenta" VALUES (1152, 2, 32422988.00, 35105.00, 0.00, 32423424.00, NULL, 1, 1, '2018-06-29 19:53:25', '2018-07-01 00:08:24');
...
-- Records of ingreso
-- ----------------------------
INSERT INTO "pagos"."ingreso" VALUES (29, 1, 1, 2, 32423424.00, 56.00, '2018-06-05 00:00:00', 'fg', 1, 8, '2018-06-29 23:53:25', '2018-06-29 23:53:25', 8);
...
-- ----------------------------
INSERT INTO "pagos"."movimiento" VALUES (23, 29, 'Ingreso', 'Crédito', 32423424.00, '2018-06-29 19:53:25', 'fg', 1, 1, '2018-06-29 19:53:25', NULL);
...
INSERT INTO "pagos"."solicitud" VALUES (14, 'SOL002', 'AMBULACIA', 3534534.00, '2018-06-01 00:00:00', 1, 2, 3, NULL, 1, 8, '2018-06-30 00:00:31', '2018-06-30 00:00:31');
...
INSERT INTO "pagos"."users" VALUES (1, 'luisa', 'lyustis@gmail.com', '$2y$10$6Qs4V0VTicMSgbL8crvEgef.TL5aOEDmuI/NkCrmOgADWwTlxSi66', 'M9skizEo0dI4i6ggmhU69xIFdGezFLGXFsqOtUQnRrM0uWQeiV2LfGnpEQ9h', NULL, '2018-06-09 15:32:29');
...
SELECT setval('"pagos"."cuenta_id_cuenta_seq"', 1153, true);
SELECT setval('"pagos"."det_cuenta_id_det_cuenta_seq"', 2, false);
SELECT setval('"pagos"."ejecucion_pago_id_ejecucion_pago_seq"', 3, true);
...
SELECT setval('"pagos"."ingreso_id_ingreso_seq"', 30, true);
...
SELECT setval('"pagos"."movimiento_id_movimiento_seq"', 24, true);
SELECT setval('"pagos"."pagos_id_pago_seq"', 15, true);
SELECT setval('"pagos"."permiso_id_permiso_seq"', 9, true);
SELECT setval('"pagos"."rol_id_rol_seq"', 4, true);
SELECT setval('"pagos"."solicitud_id_solicitud_seq"', 15, true);
...
SELECT setval('"pagos"."tr_bitacora_id_bitacora_seq"', 242, true);
